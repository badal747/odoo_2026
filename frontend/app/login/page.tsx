...
export default function LoginPage() {
  ...
  // Selected Blog Post for Reading Modal
  ...
  return (
    <div className="min-h-screen w-full bg-white flex flex-col selection:bg-slate-900 selection:text-white">
      {/* 1. HERO SECTION: Sign In Form + Rotating AI Showcase Slider */}
      <section className="min-h-screen w-full flex flex-col lg:flex-row border-b border-slate-200">
        ...
        <div className="w-full lg:w-1/2 min-h-screen flex flex-col justify-between p-6 sm:p-10 lg:p-12 xl:p-16">
          ...
          <div className="my-auto max-w-sm w-full mx-auto py-8">
            ...
            {/* Error Banner */}
            {errorMsg && (
              <div className="p-3 mb-5 bg-rose-50 border border-rose-200 rounded-xl text-xs text-rose-700 font-medium flex items-center space-x-2 animate-in fade-in duration-150">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Sign In Button (Solid Black Button Standard) */}
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3 bg-black hover:bg-slate-800 text-white font-semibold rounded-xl text-xs transition-all flex items-center justify-center space-x-2 shadow-sm disabled:opacity-50 mt-3 active:scale-95"
              >
          ...
          <div className="pt-4 border-t border-slate-100 flex items-center justify-between text-xs text-slate-400">
            <span>© 2026 PeoplePay360 Inc.</span>
            <div className="flex items-center space-x-3">
              <a href="#about-us" className="hover:text-slate-900 transition-colors">
                About Platform
              </a>
              <span>•</span>
      ...
      {/* 2. ABOUT US SECTION */}
      <section id="about-us" className="py-20 sm:py-28 px-6 sm:px-12 lg:px-20 bg-slate-50/60 border-b border-slate-200 scroll-mt-6">
        <div className="max-w-6xl mx-auto space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm hover:border-slate-300 hover:shadow-elevated transition-all flex flex-col justify-between">
              <div className="space-y-3">
                <div className="w-12 h-12 rounded-xl bg-black text-white flex items-center justify-center shadow-sm">
                  <Zap className="w-6 h-6" />
                </div>
                <h3 className="text-base font-bold text-slate-900">Python AST Payroll Engine</h3>
              ...
              <div className="pt-4 mt-4 border-t border-slate-100 text-[11px] font-semibold text-slate-700 flex items-center space-x-1">
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm hover:border-slate-300 hover:shadow-elevated transition-all flex flex-col justify-between">
              <div className="space-y-3">
                ...
                <h3 className="text-base font-bold text-slate-900">Real-Time Attendance</h3>
                <p className="text-xs text-slate-500 leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm hover:border-slate-300 hover:shadow-elevated transition-all flex flex-col justify-between">
              <div className="space-y-3">
                ...
                <h3 className="text-base font-bold text-slate-900">Zero-Conflict RBAC Security</h3>
                <p className="text-xs text-slate-500 leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm hover:border-slate-300 hover:shadow-elevated transition-all flex flex-col justify-between">
              <div className="space-y-3">
                ...
                <h3 className="text-base font-bold text-slate-900">Bank-Ready Disbursement</h3>
                <p className="text-xs text-slate-500 leading-relaxed">
          ...
          <div className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200 shadow-sm grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div>
              <div className="text-2xl sm:text-3xl font-extrabold text-slate-900 font-mono">1,500+</div>
              <div className="text-xs text-slate-500 mt-1 font-semibold">Active Employees Managed</div>
            </div>
            <div>
              <div className="text-2xl sm:text-3xl font-extrabold text-slate-900 font-mono">99.98%</div>
              <div className="text-xs text-slate-500 mt-1 font-semibold">Punctuality Tracking Accuracy</div>
            </div>
            <div>
              <div className="text-2xl sm:text-3xl font-extrabold text-slate-900 font-mono">₹12.4 Cr+</div>
              <div className="text-xs text-slate-500 mt-1 font-semibold">Net Salaries Disbursed</div>
            </div>
            <div>
              <div className="text-2xl sm:text-3xl font-extrabold text-slate-900 font-mono">&lt; 1 Sec</div>
              <div className="text-xs text-slate-500 mt-1 font-semibold">Payroll Computation Speed</div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* 3. BLOG SECTION */}
      <section id="blog" className="py-20 sm:py-28 px-6 sm:px-12 lg:px-20 bg-white border-b border-slate-200 scroll-mt-6">
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
            ...
            <a
              href="#about-us"
              className="inline-flex items-center space-x-1.5 text-xs font-semibold text-slate-700 hover:text-black self-start md:self-auto hover:underline"
            >
              ...
              >
                ...
                <div className="p-5 pt-3 border-t border-slate-100 flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      <div className="text-xs font-semibold text-slate-900 leading-tight">{post.author}</div>
      ...
      {/* 4. CLEAN MODERN LANDING FOOTER */}
      <footer className="bg-slate-900 text-white py-14 px-6 sm:px-12 lg:px-20">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 border-b border-slate-800 pb-8">
          <div className="space-y-2 text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start space-x-2.5">
              <div className="w-8 h-8 rounded-lg bg-white text-slate-900 flex items-center justify-center font-black text-sm shadow-sm">
                P
              </div>
              <span className="text-lg font-bold tracking-tight text-white">
                PeoplePay<span className="text-slate-300">360</span>
              </span>
            </div>
            <p className="text-xs text-slate-400 max-w-sm leading-relaxed">
              Integrated Human Resource and Automated Statutory Payroll Operations Platform built for high-growth enterprises.
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto pt-6 flex flex-col sm:flex-row items-center justify-between text-[11px] text-slate-500 gap-3">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-slate-400 font-medium">Enterprise Cloud v1.0 • Odoo Platform</span>
          </div>
        </div>
      </footer>
